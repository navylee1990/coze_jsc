        ...
        {selectedView === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <Badge variant={selectedTimeRange === 'current' ? 'default' : 'outline'} 
                     className={`cursor-pointer ${selectedTimeRange === 'current' ? 'bg-blue-600' : ''}`}
                     onClick={() => setSelectedTimeRange('current')}>
                本月
              </Badge>
              <Badge variant={selectedTimeRange === 'threeMonth' ? 'default' : 'outline'} 
                     className={`cursor-pointer ${selectedTimeRange === 'threeMonth' ? 'bg-blue-600' : ''}`}
                     onClick={() => setSelectedTimeRange('threeMonth')}>
                1-3月
              </Badge>
              <Badge variant={selectedTimeRange === 'sixMonth' ? 'default' : 'outline'} 
                     className={`cursor-pointer ${selectedTimeRange === 'sixMonth' ? 'bg-blue-600' : ''}`}
