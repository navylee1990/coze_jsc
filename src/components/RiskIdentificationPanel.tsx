...
const TAB_COLOR_SCHEMES = {
  0: { // 未按计划下单 - 红色（严重警告）
    ...
    cardGradient: 'from-white to-red-50/50',
    ...
    buttonHover: 'hover:from-red-200 hover:to-red-100',
    shadow: 'shadow-sm',
  ...
  1: { // 大项目依赖 - 蓝色（结构、依赖）
    ...
    cardGradient: 'from-white to-blue-50/50',
    ...
    neon: 'text-blue-600',
    glow: 'shadow-sm',
    buttonGradient: 'from-blue-100 to-blue-50',
    buttonHover: 'hover:from-blue-200 hover:to-blue-100',
    shadow: 'shadow-sm',
    hoverShadow: 'hover:shadow-md',
  },
  2: { // 预测不足 - 橙色（警告）
    ...
    cardGradient: 'from-white to-orange-50/50',
    border: 'border-orange-200',
    text: 'text-slate-900',
    textMuted: 'text-slate-500',
    textHighlight: 'text-orange-600',
    neon: 'text-orange-600',
    glow: 'shadow-sm',
    buttonGradient: 'from-orange-100 to-orange-50',
    buttonHover: 'hover:from-orange-200 hover:to-orange-100',
    shadow: 'shadow-sm',
    hoverShadow: 'hover:shadow-md',
  },
  3: { // 报备不足 - 紫色（流程）
    ...
    cardGradient: 'from-white to-purple-50/50',
    border: 'border-purple-200',
    text: 'text-slate-900',
    textMuted: 'text-slate-500',
    textHighlight: 'text-purple-600',
    neon: 'text-purple-600',
    glow: 'shadow-sm',
    buttonGradient: 'from-purple-100 to-purple-50',
    buttonHover: 'hover:from-purple-200 hover:to-purple-100',
    shadow: 'shadow-sm',
    hoverShadow: 'hover:shadow-md',
  },
  4: { // 转化不足 - 粉色（机会）
    ...
    cardGradient: 'from-white to-pink-50/50',
    ...
    neon: 'text-pink-600',
    glow: 'shadow-sm',
    buttonGradient: 'from-pink-100 to-pink-50',
    buttonHover: 'hover:from-pink-200 hover:to-pink-100',
    shadow: 'shadow-sm',
    hoverShadow: 'hover:shadow-md',
  },
  5: { // 阶段停滞 - 青色（需要推进）
    ...
    cardGradient: 'from-white to-cyan-50/50',
    ...
    neon: 'text-cyan-600',
    glow: 'shadow-sm',
    buttonGradient: 'from-cyan-100 to-cyan-50',
    buttonHover: 'hover:from-cyan-200 hover:to-cyan-100',
    shadow: 'shadow-sm',
    hoverShadow: 'hover:shadow-md',
  },
};
