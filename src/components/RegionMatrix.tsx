...
export default function RegionMatrix({
  ...
  return (
    <div className={cn('w-full h-[600px]', DASHBOARD_STYLES.bg, DASHBOARD_STYLES.text)}>
      {/* 标题栏 - 固定高度 */}
      <div
        className={cn(
      ...
      {/* 排名列表 */}
      <div className={cn(
        'border-2 rounded-xl overflow-hidden flex flex-col flex-1',
        ...
        {/* 分页控件或信息栏 - 固定高度 */}
        <div className="h-12 flex-shrink-0 flex items-center justify-between px-4 border-t border-cyan-500/20 bg-slate-900/30">
